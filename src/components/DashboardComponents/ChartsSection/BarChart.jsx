...
const barShow = (root) => {
  ...
  series.columns.template.setAll({
    tooltipHTML:
      "<span style='font-size:10px; font-family: `DM Sans`; font-weight: 700; color:#FFFFFF;'><b>{hour}</b></span><br><img src='/tooltip-icon.svg' style='vertical-align:bottom; margin-bottom: 2px; margin-right: 5px; width:12px; height:12px;'><span style='font-size:10px; font-family: `DM Sans`; font-weight: 700; color:#FFFFFF;'><b>{valueY}</b></span>",
  });
